...
folder are mapped to the application's root namespace, 'Extjs.learning'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Extjs.learning' in the same way
as `"Extjs.learning/sass/src"`.
